...
def cmb(num_vertices, num_edges, num_colors, weights, edges, r, I, initial_prob, final_prob):
    ...
    initial_teperature = 50 #get_initial_temperature(initial_solution, init_temp_temperature, r, init_temp_iterations, initial_prob, num_vertices, num_edges, num_colors, weights)
